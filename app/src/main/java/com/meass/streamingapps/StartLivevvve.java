...
public class StartLivevvve extends AppCompatActivity {
    String new_1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_livevvve);
        ////setup voice
        try {
        ...
        send_message_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(message)) {
                    Toast.makeText(StartLivevvve.this, "Enter Message", Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(StartLivevvve.this, "Sent", Toast.LENGTH_SHORT).show();
                            reloadMessage();
                        }
                    }
                });
...
//////live
        ...
        linear1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder=new AlertDialog.Builder(StartLivevvve.this);
...
//////
    ...
    private void showRequestedDialog() {
        final BottomSheetDialog cohost = new BottomSheetDialog(StartLivevvve.this);
    ...
    private void showBottomSheetDialog() {
        final BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(StartLivevvve.this);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (menuitem==R.id.request) {
            final BottomSheetDialog bottomSheetDialog11 = new BottomSheetDialog(StartLivevvve.this);
