...
public class JoinAsHost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_join_as_host);
        ...
        if (checkSelfPermission()) {
            ...
            if (audienceRole.isChecked()) { //Audience
                Toast.makeText(JoinAsHost.this, "You can talk   now.", Toast.LENGTH_SHORT).show();
        ...
        send_message_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(message)) {
                    Toast.makeText(JoinAsHost.this, "Enter Message", Toast.LENGTH_SHORT).show();
                    ...
                    firebaseFirestore.collection("LiveMessgae")
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(JoinAsHost.this, "Sent", Toast.LENGTH_SHORT).show();
                                        reloadMessage();
                                    }
                                }
                            });
...
//////live
        ...
        linear1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder=new AlertDialog.Builder(JoinAsHost.this);
...
FirebaseFirestore firebaseFirestore;
    ...
    private void reloadMessage() {
        ...
        mymessage.post(new Runnable() {
            ...
            public void run() {
                // Call smooth scroll
                mymessage.smoothScrollToPosition(getDataAdapter1.getItemCount() - 1);
    ...
    private void showBottomSheetDialog() {
        final BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(JoinAsHost.this);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (menuitem==R.id.request) {
            final BottomSheetDialog bottomSheetDialog11 = new BottomSheetDialog(JoinAsHost.this);
            ...
            documentReference =    firebaseFirestore.collection("UserJoinRequest_user")
                    ...
                    .collection("List")
                    .document();
            recyclerView =(RecyclerView)bottomSheetDialog11. findViewById(R.id.mymessage_rechost);
    ...
    private void showRequestedDialog() {
        final BottomSheetDialog cohost = new BottomSheetDialog(JoinAsHost.this);
    ...
    FirebaseFirestore firebaseFxirestore;
